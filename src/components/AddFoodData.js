...
// AddDoc is used to add documenst in firebase, collection se ek seperate folder ban jata h, jiske andar cheeze daal sakte h
...
const AddFoodData = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (foodImage == null) {
            ...
            // ref(storage, path) : used to store images in storage
            const imageRef = ref(storage, `FoodImages/${foodImage.name}`)
            uploadBytes(imageRef, foodImage).then(() => {
                alert('Image uploaded successfully');
                // now to download the ue=rl generated by firebase, use get download
                // firebase stoarge m images upload krte h, aur firebase ek url deta h, jise hum use krte h website banane m
                getDownloadURL(imageRef).then((url) => {
                    ...
                    try {
                        // collection : used to store text in db (firestore)
